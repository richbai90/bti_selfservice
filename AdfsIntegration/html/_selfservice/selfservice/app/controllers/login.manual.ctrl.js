(function () {
  ...
  angular.module('swSelfService').controller('LoginManualController', LoginManualController);
        ...
        $scope.sessServ.getSelfServiceConfig($scope.username).then(function () {
          ...
          $scope.sessServ.getCustomerDetails($scope.username, $scope.wssConfig.ac_id).then(function (custDetails) {
            ...
            RequestService.getAuthCount().then(function (response) {
              ...
              if (stateBefore !== "new_password" && $rootScope.goToPath !== '/' && $rootScope.goToPath !== '/login' && $rootScope.goToPath !== '/loginsso' && $rootScope.goToPath !== '/loginmanual') {
...
//# sourceMappingURL=login.manual.ctrl.js.map