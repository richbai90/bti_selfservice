...
//SG - modified bootstrap3 theme for smaller inputs
JSONEditor.defaults.themes.bootstrap3sm = JSONEditor.AbstractTheme.extend({
  getSelectInput: function(options) {
    var el = this._super(options);
  ...
  getHeaderButtonHolder: function() {
    var el = this.getTitleButtonHolder();
    el.style.marginRight = '10px';
    return el;
  },
  getTitleButtonHolder: function() {
    var el = document.createElement('div');
