(function () {
  ...
  module.run(function ($rootScope, $state, $cookies, SWSessionService, RequestService, defaultErrorMessageResolver, $location, store, wssLogging) {
    ...
    $rootScope.$on('$stateChangeStart', function (e, toState, toParams, fromState, fromParams) {
      if ($location.path() !== '/login' && $location.path() !== '/loginmanual' && $location.path() !== '/loginsso' && $location.path() !== '/new_password') {
      ...
      if (toState.data && toState.data.requiresLogin) {
        ...
        if (!$cookies.get('swSessionID')) {
          ...
          if (fromState.url !== '^' && fromState.name !== '\login' && fromState.name !== '\loginsso' && fromState.name !== '\loginmanual') {
    ...
    $rootScope.$on('$stateChangeSuccess', function (e, toState, toParams, fromState, fromParams) {
      ...
      if (fromState.name === '' && toState.name !== 'login' && toState.name !== 'loginmanual' && toState.name !== 'loginsso') {
      ...
      } else if (toState.name !== 'login' && toState.name !== 'loginmanual' && toState.name !== 'loginsso') {
      ...
      } else if (toState.name === 'login' || toState.name === 'loginmanual' || toState.name === 'loginsso' || toState.name === 'new_password') {
