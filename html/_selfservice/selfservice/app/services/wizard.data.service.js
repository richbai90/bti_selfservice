(function () {
  ...
  angular.module('swSelfService').service('WizardDataService', WizardDataService);
  ...
  function WizardDataService($rootScope, $q, XMLMCService, WizardFilterService, store, wssHelpers, $uibModal, wssLogging) {
            ...
            angular.forEach(questionArray, function (qVal, qKey) {
              ...
              if (qVal.type === 'Selectbox' || qVal.type === 'Radiobox' || qVal.type === 'Checkbox') {
                ...
                const gettingQuestionOptions = self.getQuestionOptions(qVal).then(function (respOptions) {
                  ...
                  if (angular.isDefined(questionArray[qKey].defaultvalue) && questionArray[qKey].defaultvalue !== "") {
    ...
    self.getQuestionOptions = function (qObj) {
      ...
      xmlmc.invoke("data", "invokeStoredQuery", {
        onSuccess: function (params) {
          ...
          if (angular.isDefined(qObj.dbtable) && qObj.dbtable !== "" && angular.isDefined(qObj.keycol) && qObj.keycol !== "" && angular.isDefined(qObj.txtcol) && qObj.txtcol !== "") {
    ...
    self.getSLAQuestion = function (objDataform, objService) {
      ...
      var objSLAQuestion = {};
      var strRelType = '';
      if (!angular.isDefined(objDataform.cp_sla_first) || angular.isDefined(objDataform.cp_sla_first) && objDataform.cp_sla_first === 'Service') {
        strRelType = 'SERV';
...
//# sourceMappingURL=wizard.data.service.js.map