...
(function () {
  ...
  angular.module('swSelfService').controller('ServiceListCtrl', ServiceListCtrl);
  ...
  function ServiceListCtrl($rootScope, $scope, $q, $state, SWSessionService, wssHelpers, ServicesService, ServiceCategoryService, paginationService, store, $uibModal, wssLogging, $window, GlobalSearchService) {
    ...
    $scope.getDetails = function (serviceId) {
      ...
      $scope.custServices.getServiceDetails(serviceId).then(function (objServDetails) {
    ...
    $scope.getActiveRequest = function (serviceId) {
      ...
      $scope.custServices.activeRequest(serviceId).then(function (objRequest) {
    ...
    $scope.getCloseRequest = function (serviceId) {
      ...
      $scope.custServices.closeRequest(serviceId).then(function (objRequest) {
    ...
    $scope.canRaiseIncident = function (service) {
      return service.flg_allow_support === '1' && $scope.canLogCall() && $scope.custServices.listType !== 'own' && $scope.custServices.listType !== 'unsub';
    };

    $scope.canRaiseRequest = function (service) {
      return service.flg_allow_request === '1' && $scope.canLogCall() && $scope.custServices.listType !== 'own' && $scope.custServices.listType !== 'unsub';
    };
    //
...
//# sourceMappingURL=service.list.ctrl.js.map